  ...
  <ul align="center" style="list-style: none">
    <summary>
      ...
      ```
        ...
        works with static websites, so various features will not be present, especially backend 
        parts. To access the complete project, click on the card (below the image) and clone the repository.
      ```
